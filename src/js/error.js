const obj_error = {
    ...
    passwordLowercaseCharacters: "Пароль должен содержать 1 маленькую букву",
    passwordNumberCharacters: "Пароль должен содержать 1 цифру",
    passwordSpecialCharacters: "Пароль должен содержать 1 спец символ",
    emptyFieldLogin: "Поле Login не заполнено",
    emptyFieldPassword: "Поле Password не заполнено",
};
export default obj_error;